...
export interface DemoCustomModuleABIInterface extends utils.Interface {
  functions: {
    "addAssetToTokenWithTempPermission(uint256,uint64,uint64)": FunctionFragment;
    "mintAndAddAssetToToken(uint64,uint64)": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic:
      | "addAssetToTokenWithTempPermission"
      | "mintAndAddAssetToToken"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "addAssetToTokenWithTempPermission",
    values: [
  ...
  events: {
    ...
    "LightmCollectionOwnerSet(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LightmCollectionOwnerSet"): EventFragment;
  getEvent(
...
export interface LightmCollectionOwnerSetEventObject {
  newOwner: string;
}
export type LightmCollectionOwnerSetEvent = TypedEvent<
  [string],
  LightmCollectionOwnerSetEventObject
>;

export type LightmCollectionOwnerSetEventFilter =
  TypedEventFilter<LightmCollectionOwnerSetEvent>;
...
export interface DemoCustomModuleABI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DemoCustomModuleABIInterface;
  ...
  filters: {
    ...
    "LightmCollectionOwnerSet(address)"(
      newOwner?: null
    ): LightmCollectionOwnerSetEventFilter;
    LightmCollectionOwnerSet(
      newOwner?: null
    ): LightmCollectionOwnerSetEventFilter;
