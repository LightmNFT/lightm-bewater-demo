...
import type {
  DemoCustomModuleABI,
  DemoCustomModuleABIInterface,
} from "../DemoCustomModuleABI";
...
const _abi = [
  ...
  },
  {
    ...
    name: "addAssetToTokenWithTempPermission",
    outputs: [],
...
export class DemoCustomModuleABI__factory {
  static readonly abi = _abi;
  static createInterface(): DemoCustomModuleABIInterface {
    return new utils.Interface(_abi) as DemoCustomModuleABIInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DemoCustomModuleABI {
    return new Contract(address, _abi, signerOrProvider) as DemoCustomModuleABI;
  }
}
